...
"""
sfhformer_haze model implementation.

This file is implemented with reference to the following paper:

Jiang, X., Zhang, X., Gao, N., & Deng, Y. (2025).
When Fast Fourier Transform Meets Transformer for Image Restoration.
In A. Leonardis et al. (Eds.), Computer Vision – ECCV 2024
(pp. 381-402). Springer Nature Switzerland.
"""
...
def sfhformer_haze():
    return Backbone_new(
        ...
        # embed_dim=[32, 64, 128, 256, 512, 256, 128, 64, 32],
        # depth=[4, 8, 12, 16, 32, 16, 12, 8, 4],
        embed_dim = [32, 64, 128, 256, 512, 256, 128, 64, 32],
        depth = [4, 6, 6, 8, 12, 8, 6, 6, 4],

        # embed_dim=[32, 64, 128, 256, 128, 64, 32],   #  gpt  2026 0117
        # depth    =[4, 4, 6, 6, 6, 4, 4],  #

        #embed_dim=[32, 64, 128, 256,512,256, 128, 64, 32],
        #depth = [2, 2, 4, 4, 4, 4, 4, 2, 2],
        #depth = [3, 3, 6, 6, 6, 6, 6, 3, 3],
        #depth = [4, 4, 8, 8, 8, 8, 8, 4, 4],
